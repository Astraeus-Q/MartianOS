...
// New syscalls:
extern int32_t ece391_goin (const uint8_t* path);
extern int32_t ece391_createfolder (const uint8_t* path);
extern int32_t ece391_deletefolder (const uint8_t* path);
extern int32_t ece391_createfile (const uint8_t* path);
extern int32_t ece391_deletefile (const uint8_t* path);
